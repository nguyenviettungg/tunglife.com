 $(function(){
 	new WOW().init();
 	var vitrifooter = $('.footer').offset().top;
 	console.log(vitrifooter);
 	$(window).scroll(function(event) {
 		var vitrimenuduoi = $('.phanmenuselect').offset().top;
 		var vitrifooter = $('.footer').offset().top;
 		...
 		{	
	 		...
	 		$('.phanmenuduoi .navbar').addClass('navbar-fixed-top maunenden fadeInDown animated');
 	 		...
 	 		// $('.phanthanhgiohang .navbar').addClass('navbar-fixed-bottom maunenden fadeInUp animated');
 			...
 			// $('.phanthanhgiohang .navbar').removeClass('navbar-fixed-bottom maunenden fadeInUp animated');	
 		}
 		if (vitri > 500 && vitri <5290) {
 			$('.phanthanhgiohang .navbar').addClass('navbar-fixed-bottom maunenden fadeInUp animated');
 		}
 		else {
 			$('.phanthanhgiohang .navbar').removeClass('navbar-fixed-bottom maunenden fadeInUp animated');
